  ...
  const items = [
    {
      ...
      description: 'Salesix keeps your data locked, compliant, and always protected.',
      showGitHubInfo: true,
      columns: [
        {
          title: 'Built for Enterprise Trust',
          description: 'Salesix ensures your data, workflows, and communications meet the highest security and compliance standards.',
        },
        {
          title: 'Security That Scales',
          description: 'From startups to enterprises, Salesix safeguards your business with scalable, future-proof protection.',
        },
      ],
    },
    {
      ...
      title: 'Expand Beyond Boundaries',
      description: 'Connect with anyone, anywhere — powered by Salesix AI.',
      showFeatures: true,
      columns: [
        {
          title: 'Multi-Language Support',
          description: 'Salesix helps your AI agents communicate effortlessly in any language, building global connections.',
        },
        {
      ...
      <div className="relative w-full px-6">
        <div className="max-w-6xl mx-auto border-l border-r border-border">
          ...
          <SectionHeader>
            ...
            Empower your business with Salesix. <br/>The AI that understands, responds, and delivers results.
            </p>
          </SectionHeader>
