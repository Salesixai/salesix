...
import { Loader2, ArrowUp, X, Image as ImageIcon, Presentation, BarChart3, FileText, Search, Users, Code2, Sparkles, Brain as BrainIcon, MessageSquare, Phone, Megaphone, Building2, CornerDownLeft, Plug } from 'lucide-react';
